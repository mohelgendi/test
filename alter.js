var pwgScript = document.createElement('script');pwgScript.src = 'https://form.crmmedyaglobal.com/Templates/pwg.js';document.getElementsByTagName('head')[0].appendChild(pwgScript);pwgScript.onload = function() {var validasyonDilScript = document.createElement('script');validasyonDilScript.src = 'https://form.crmmedyaglobal.com/Templates/validateenginelanguages/jquery.validationEngine-tr.js';document.getElementsByTagName('head')[0].appendChild(validasyonDilScript);validasyonDilScript.onload = function() {var validasyonScript= document.createElement('script');validasyonScript.src = 'https://form.crmmedyaglobal.com/Templates/validateengine.js';document.getElementsByTagName('head')[0].appendChild(validasyonScript);validasyonScript.onload = function() {var inputMaskScript = document.createElement('script');inputMaskScript.src = 'https://form.crmmedyaglobal.com/Templates/inputmask.js';document.getElementsByTagName('head')[0].appendChild(inputMaskScript);inputMaskScript.onload = function() {var dateTimePickerScript = document.createElement('script');dateTimePickerScript.src = 'https://form.crmmedyaglobal.com/Templates/datepicker.min.js';document.getElementsByTagName('head')[0].appendChild(dateTimePickerScript);dateTimePickerScript.onload = function() {var numericJs = document.createElement('script');numericJs.src = 'https://form.crmmedyaglobal.com/Templates/numeric.min.js';document.getElementsByTagName('head')[0].appendChild(numericJs);numericJs.onload = function() {
...
var link = "https://" + host + "/Form/FormSablonu?sablonID=0f9634e6-5009-4370-a3c7-fb050cbac30b";
    ...
    $.get(link, function (res) {
        ...
        $("#" + formid).submit(function (event) {
            ...
            if ($("#" + formid).validationEngine('validate')) {
                ...
                var postData = { inputIdler: inputIdler, inputValueler: inputValueler, curUrl: curUrl, refUrl: refUrl, os: os, browser: browser, utm: utm, adSoyad: adSoyad, telefon: telefon, email: email, mesaj: mesaj, izin: izin, gclid: gclid };
